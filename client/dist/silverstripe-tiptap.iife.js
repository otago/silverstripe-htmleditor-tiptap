...
3. "-" cannot repeat`);
  ...
  function createCommandTool({ action, extension, tooltipKey, defaultTitle, canMethod, runMethod, canArgs = [], runArgs = [], isActive: isActive2 }) {
    return {
      action,
      ...
      isActive(editor) {
        if (typeof isActive2 === "function") {
          return isActive2(editor);
        }
        return false;
      },
      isDisabled(editor) {
  ...
  const alignCenter = createCommandTool({
    action: "alignCenter",
    extension: "textAlign",
  ...
  const alignJustify = createCommandTool({
    action: "alignJustify",
    extension: "textAlign",
  ...
  const alignLeft = createCommandTool({
    action: "alignLeft",
    extension: "textAlign",
  ...
  const alignRight = createCommandTool({
    action: "alignRight",
    extension: "textAlign",
  ...
  const blockquote = createCommandTool({
    action: "blockquote",
  ...
  const codeBlock = createCommandTool({
    action: "codeBlock",
    extension: "codeBlock",
  ...
  const heading2 = createCommandTool({
    action: "heading2",
    extension: "heading",
    tooltipKey: "heading2",
  ...
  const heading3 = createCommandTool({
    action: "heading3",
    extension: "heading",
    tooltipKey: "heading3",
  ...
  const heading4 = createCommandTool({
    action: "heading4",
    extension: "heading",
    tooltipKey: "heading4",
  ...
  const heading5 = createCommandTool({
    action: "heading5",
    extension: "heading",
    tooltipKey: "heading5",
  ...
  const heading6 = createCommandTool({
    action: "heading6",
    extension: "heading",
    tooltipKey: "heading6",
  ...
  const highlight = createCommandTool({
    action: "highlight",
    extension: "highlight",
  ...
  const horizontalRule = createCommandTool({
  ...
  const subscript = createCommandTool({
    action: "subscript",
    extension: "subscript",
  ...
  const superscript = createCommandTool({
    action: "superscript",
  ...
  const strikethrough = createCommandTool({
  ...
  function isTableActionDisabled(action, editor) {
    switch (action) {
  ...
  function getTableOptions(tooltips) {
  ...
  const createTableOptionButton = ({ option, editor, dropdown, dropdownMenu, context }) => {
    ...
    const parts = parseTooltipText(option.text);
    const optionBtn = $2(`<button type="button" data-option-action="${optionAction}" data-parent-action="table">${parts.title}</button>`);
    addTooltip(optionBtn, option.text);
    optionBtn.on("click", (event) => {
      event.preventDefault();
      event.stopPropagation();
  ...
  const underline = createCommandTool({
    action: "underline",
    extension: "underline",
...
`;
  ...
  function enterHtmlSource(editor, wrapper, context) {
    const {
      $: $2,
      constants,
      autoResizeTextarea,
  ...
  (function($2) {
    ...
    $2.entwine("ss", function($3) {
      $3("textarea.htmleditor").entwine({
        onmatch: function() {
          let config;
          try {
        ...
        onunmatch: function() {
          ...
          if (wrapper) {
            wrapper.find("button").each(function() {
              const tooltip = $3(this).data("tooltip");
              if (tooltip) {
                tooltip.remove();
              }
            });
        ...
        createToolbarButton: function(itemConfig, editor) {
          const button = $3(`<button type="button" data-action="${itemConfig.action}">${itemConfig.buttontext}</button>`);
          const self = this;
        ...
        findElementReduxFormName: function() {
          ...
          const elementForms = ((_c = (_b = (_a = store.getState()) == null ? void 0 : _a.form) == null ? void 0 : _b.formState) == null ? void 0 : _c.element) || {};
